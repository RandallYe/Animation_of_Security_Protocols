...
printFP (FP x) = case (read x) of 
  ...
  (Send_s_C (a, (b, c))) -> "Send_s [" ++ Prelude.show a ++ "=>" ++ Prelude.show b ++ "] " ++ ppChan c;
  (Recv_s_C (a, (b, c))) -> "Recv_s [" ++ Prelude.show b ++ "<=" ++ Prelude.show a ++ "] " ++ ppChan c;
  (Hear_C (a, (b, c))) -> "Hear [" ++ Prelude.show b ++ "<=" ++ Prelude.show a ++ "] " ++ ppChan c;
  (Fake_C (a, (b, c))) -> "Fake [" ++ Prelude.show b ++ "=>" ++ Prelude.show a ++ "] " ++ ppChan c;
  -- (Send_C (a, (b, c))) -> "Send [" ++ Prelude.show a ++ [ ('\x2B95'), ' '] ++ Prelude.show b ++ "] " ++ ppChan c;
  -- (Recv_C (a, (b, c))) -> "Recv [" ++ Prelude.show b ++ [ ('\x2B05'), ' '] ++ Prelude.show a ++ "] " ++ ppChan c;
  -- (Hear_C (a, (b, c))) -> "Hear [" ++ Prelude.show b ++ [ ('\x27A1'), ' '] ++ Prelude.show a ++ "] " ++ ppChan c;
  -- (Fake_C (a, (b, c))) -> "Fake [" ++ Prelude.show b ++ [ ('\x2B05'), ' '] ++ Prelude.show a ++ "] " ++ ppChan c;
...
-- ppChan (MCmp m1 m2) = ['\x3008'] ++ ppChan m1 ++ ", " ++ ppChan m2 ++ ['\x3009'];
ppChan (MEnc m1 k) = ['{'] ++ ppChan m1 ++ ['}'] ++ "_" ++ ppShow k;
ppChan (MSig m1 k) = ['{'] ++ ppChan m1 ++ ['}'] ++ "^s_" ++ ppShow k;
