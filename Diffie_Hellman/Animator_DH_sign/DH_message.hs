...
module
  DH_message(Dagent(..), equal_dagent, Dnonce(..), equal_dnonce, Dsig(..),
              ...
              is_MKs, length, pair2, enum_dagent, enum_dpkey, allPKs,
              enum_dskey, allSKs, break_lst, breakl, breakm, mn, mc1, mc2, mkp,
              mks, msd, msk, pa, mod_exp1, mod_exp2, allAgents, enum_dnonce,
              allNonces, allPKsLst, un_fake_C, is_fake_C, fake, un_hear_C,
              is_hear_C, hear, un_leak_C, is_leak_C, leak, un_recv_C, is_recv_C,
              recv, un_send_C, is_send_C, send, is_MNon, extract_nonces,
              mod_exp1a, mod_exp2a, is_MKp, inv_p, sig_1, allAgentsLst,
...
build1_n_2 :: [Dmsg] -> [Dmsg];
build1_n_2 ns =
  build1_n ns Arith.one_nat Arith.one_nat (Arith.nat_of_integer (2 :: Integer));
